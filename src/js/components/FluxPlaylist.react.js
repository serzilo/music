...
var FluxPlaylist = React.createClass({
	...
	render: function() {
		return (
			<div className={'playlist' + (this.props.show == true ? ' playlist_show' : '')} onMouseEnter={this.enterHandler} onTouchStart={this.enterHandler} onMouseLeave={this.leaveHandler} onTouchEnd={this.leaveHandler} onTouchCancel={this.leaveHandler}>
				...
				<div className="playlist__content-scroll">
